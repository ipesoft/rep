...
class Taxon( models.Model ):
    ...
    # todo: potential_use
    rare        = models.BooleanField( _(u'Rare'), null=True, blank=True )
    max_density = models.IntegerField( _(u'Maximum density'), help_text=_(u'individuals per hectare'), null=True, blank=True )
    endemic = models.BooleanField( _(u'Endemic'), null=True, blank=True )
    ...
    pruning = models.BooleanField( _(u'Requires pruning'), null=True, blank=True )
    ...
    symbiotic_assoc   = models.BooleanField( _(u'Presence'), null=True, blank=True )
    ...
    thorns_or_spines = models.BooleanField( _(u'Presence'), null=True, blank=True )
    toxic_or_allergenic = models.BooleanField( _(u'Presence'), null=True, blank=True )
    ...
    wood_has_mai_curve = models.BooleanField( _(u'Has mean annual increment curve'), null=True, blank=True )
    wood_has_cai_curve = models.BooleanField( _(u'Has current annual increment curve'), null=True, blank=True )
    wood_has_biomass_equation = models.BooleanField( _(u'Has biomass equation'), null=True, blank=True )
    # other fields
